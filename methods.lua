...
function resetGravity()
    ...
    for i = 1, #planets do
        ...
        if distanceSquared < 300 * 300 then
            AddGravityX = (distanceX) / math.sqrt(distanceSquared) * 300 -- Adjust the multiplier as needed
            AddGravityY = (distanceY) / math.sqrt(distanceSquared) * 300 -- Adjust the multiplier as needed
        end
    ...
    for i = 1, #blackholes do
        ...
        if distanceSquared < 500 * 500 then
            AddGravityX = (distanceX) / math.sqrt(distanceSquared) * 600 -- Adjust the multiplier as needed
            AddGravityY = (distanceY) / math.sqrt(distanceSquared) * 600 -- Adjust the multiplier as needed
        end
